...
colors = ['어두운 빨강', '빨강', '밝은 빨강', '어두운 초록', '초록', '밝은 초록', '어두운 파랑', '파랑', '밝은 파랑', '어두운 노랑', '노랑', '밝은 노랑', '어두운 자홍', '자홍', '밝은 자홍', '어두운 청록', '청록', '밝은 청록', '어두운 주황', '주황', '밝은 주황', '어두운 보라', '보라', '밝은 보라', '어두운 분홍', '분홍', '밝은 분홍', '어두운 라임', '라임', '밝은 라임', '어두운 갈색', '갈색', '밝은 갈색', '어두운 회색', '회색', '밝은 회색', '검정', '흰색','지정안함']
