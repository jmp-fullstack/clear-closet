...
from apps.articleapp.views import article_create, article_delete, article_detail, article_is_sell, article_list, article_modify
...
urlpatterns = [
    ...
    path('isSell/<int:article_pk>', article_is_sell, name='article-isSell')
]
