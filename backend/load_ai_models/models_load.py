...
def load_yolov5_model(device):
    yolov5_best_pt_save_path = 'load_ai_models/pt_files/yolo.pt'  # pt 파일 경로
...
def load_efficientnet_model(device):
    ...
    eff_pt_name = 'load_ai_models/pt_files/trained_380_effnet.pt'  # pt 파일 경로
...
def initialize_models():
    ...
    if yolov5_model is None or effnet_v2_s_model is None:
        ...
        xgb_save_path = 'load_ai_models/pt_files/xgb_predict_price.json' 
